...
CREATE TABLE IF NOT EXISTS `t_area_city` (
  `acId` INT(11) NOT NULL COMMENT 'id',
  `anId` INT(11) DEFAULT 0 COMMENT '国家id',
  `apId` INT(11) NOT NULL COMMENT '省id',
  `anName` VARCHAR(50) COLLATE utf8mb4_bin DEFAULT '中华人民共和国' COMMENT '省名称',
  `apName` VARCHAR(25) COLLATE utf8mb4_bin NOT NULL COMMENT '省名称',
  `acName` VARCHAR(25) COLLATE utf8mb4_bin NOT NULL COMMENT '市级名称',
  `zip` VARCHAR(6) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '邮编',
  PRIMARY KEY (`acId`),
  UNIQUE KEY (`anName`, `apName`, `acName`)
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='城市表';


INSERT INTO `t_area_city` (`acId`, `apId`, `apName`, `acName`, `zip`) VALUES
	(1, 1, '北京市', '北京市', '100000'),
	(2, 2, '天津市', '天津市', '100000'),
	(3, 3, '河北省', '石家庄市', '050000'),
	(4, 3, '河北省', '唐山市', '063000'),
...
CREATE TABLE IF NOT EXISTS `t_area_district` (
  `adId` INT(11) NOT NULL COMMENT 'id',
  `apId` INT(11) NOT NULL COMMENT '省级id',
  `acId` INT(11) NOT NULL COMMENT '市级id',
  `apName` VARCHAR(10) COLLATE utf8mb4_bin NOT NULL COMMENT '省名',
  `acName` VARCHAR(16) COLLATE utf8mb4_bin NOT NULL COMMENT '城市名',
  `adName` VARCHAR(16) COLLATE utf8mb4_bin NOT NULL COMMENT '区域名称',
  PRIMARY KEY (`adId`),
  UNIQUE KEY (`apName`, `acName`, `adName`)
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='区域表';


INSERT INTO `t_area_district` (`adId`, `apId`, `acId`, `apName`, `acName`, `adName`) VALUES
	(1, 0, 1, '北京市', '北京市', '东城区'),
	(2, 0, 1, '北京市', '北京市', '西城区'),
	(3, 0, 1, '北京市', '北京市', '崇文区'),
	(4, 0, 1, '北京市', '北京市', '宣武区'),
...
CREATE TABLE IF NOT EXISTS `t_area_province` (
  `apId` INT(11) NOT NULL COMMENT 'id',
  `anId` INT(11) DEFAULT 0 COMMENT '国家id',
  `anName` VARCHAR(10) COLLATE utf8mb4_bin DEFAULT '中华人民共和国' COMMENT '国家',
  `apName` VARCHAR(10) COLLATE utf8mb4_bin NOT NULL COMMENT '省名称',
  PRIMARY KEY (`apId`),
  UNIQUE KEY (`anName`, `apName`)
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='省';



INSERT INTO `t_area_province` (`apId`, `apName`) VALUES
	(1, '北京市'),
	(2, '天津市'),
	(3, '河北省'),
	(4, '山西省'),
...
CREATE TABLE `t_area_nation` (
  `anId` int(11) NOT NULL COMMENT 'id',
  `cnContinent` varchar(10) NOT NULL COMMENT '大洲中文名',
  `engContinent` varchar(20) DEFAULT NULL COMMENT '大洲英文名',
  `abbrCnName` varchar(20) NOT NULL COMMENT '国家中文简称',
  `fullCnName` varchar(50) NOT NULL COMMENT '国家中文全称',
  `engName` varchar(40) NOT NULL COMMENT '国家英文名简称',
  `fullEngName` varchar(60) NOT NULL COMMENT '国家英文全称',
  `shortAbbrEngName` varchar(6) NOT NULL COMMENT '短英文缩写',
  `longAbbrEngName` varchar(6) NOT NULL COMMENT '长英文缩写',
  `zoneCode` varchar(6) DEFAULT NULL COMMENT '区号',
  PRIMARY KEY (`anId`),
  UNIQUE KEY `abbrCnName` (`abbrCnName`),
  UNIQUE KEY `fullCnName` (`fullCnName`),
  UNIQUE KEY `engName` (`engName`),
  UNIQUE KEY `fullEngName` (`fullEngName`),
  UNIQUE KEY `longAbbrEngName` (`longAbbrEngName`),
...
INSERT INTO `t_area_nation`
(`anId`, `cnContinent`, `engContinent`, `abbrCnName`, `fullCnName`, `engName`, `fullEngName`, `shortAbbrEngName`, `longAbbrEngName`, `zoneCode`)
VALUES
('1','未知的洲','unknown continent','未知','未知国家或地区','unknown','unknown country or region','','',''),
('2','欧洲','Europe','阿尔巴尼亚','阿尔马尼亚共和国','Albania','Republic of Albania','AL','ALB','008'),
('3','非洲','Africa','阿尔及利亚','阿尔及利亚民主人民共和国','Algeria','DemocraticPeople\'s Republic of Algeria','DZ','DZA','012'),
('4','亚洲','Asia','阿富汗','阿富汗伊斯兰国','Afghanistan','Islamic State of Afghanistan','AF','AFG','004'),
('5','南美洲','South America','阿根廷','阿根廷共和国','Argentina','Republic of Argentina','AR','ARG','032'),
('6','北美洲','North America','阿鲁巴','阿鲁巴','Aruba','Aruba','AW','ABW','533'),
('7','亚洲','Asia','阿曼','阿曼苏丹国','Oman','SultanateofOman','OM','OMN','512'),
('8','亚洲','Asia','阿塞拜疆','阿塞拜疆共和国','Azerbaijan','Republic of Azerbaijan','AZ','AZE','031'),
('9','亚洲','Asia','阿联酋','拉伯联合酋长国','UnitedArabEmirates','United Arab Emirates','AE','ARE','784'),
('10','非洲','Africa','埃及','阿拉伯埃及共和国','Egypt','Arab Republic of Egypt','EG','EGY','818'),
('11','非洲','Africa','埃塞俄比亚','埃塞俄比亚','Ethiopia','Ethiopia','ET','ETH','231'),
('12','欧洲','Europe','爱尔兰','爱尔兰','Ireland','Ireland','IE','IRL','372'),
('13','欧洲','Europe','爱沙尼亚','爱沙尼亚共和国','Estonia','Republic of Estonia','EE','EST','233'),
('14','欧洲','Europe','安道尔','安道尔公国','Andorra','Principality of Andorra','AD','AND','020'),
('15','非洲','Africa','安哥拉','安哥拉共和国','Angola','Republic of Angola','AO','AGO','024'),
('16','北美洲','North America','安圭拉','安圭拉','Anguilla','Anguilla','AI','AIA','660'),
('17','北美洲','North America','安提瓜和巴布达','安提瓜和巴布达','Antigua and Barbuda','Antigua and Barbuda','AG','ATG','028'),
('18','欧洲','Europe','奥地利','奥地利共和国','Austria','Republic of Austria','AT','AUT','040'),
('19','大洋洲','Oceania','澳大利亚','澳大利亚联邦','Australia','Commonwealth of Australia','AU','AUS','036'),
('20','北美洲','North America','巴巴多斯','巴巴多斯','Barbados','Barbados','BB','BRB','052'),
('21','大洋洲','Oceania','巴布亚新几内亚','巴布亚新几内亚独立国','PapuaNewGuinea','Independent State of Papua New Guinea','PG','PNG','598'),
('22','北美洲','North America','巴哈马','巴哈马联邦','Bahamas','Commonwealth of the Bahamas','BS','BHS','044'),
('23','亚洲','Asia','巴基斯坦','巴基斯坦伊斯兰共和国','Pakistan','Islamic Republic of Pakistan','PK','PAK','586'),
('24','南美洲','South America','巴拉圭','巴拉圭共和国','Paraguay','Republic of Paraguay','PY','PRY','600'),
('25','亚洲','Asia','巴勒斯坦','巴勒斯坦国','Palestine','State of Palestine','PS','PST','374'),
('26','亚洲','Asia','巴林','巴林国','Bahrain','State of Bahrain','BH','BHR','048'),
('27','北美洲','North America','巴拿马','巴拿马共和国','Panama','Republic of Panama','PA','PAN','591'),
('28','南非洲','South America','巴西','巴西联邦共和国','Brazil','Federative Republic of Brazil','BR','BRA','076'),
('29','欧洲','Europe','白俄罗斯','白俄罗斯共和国','Belarus','Republic of Belarus','BY','BLR','112'),
('30','北美洲','North America','百慕大','百慕大群岛','Bermuda','Bermuda Islands','BM','BMU','060'),
('31','欧洲','Europe','保加利亚','保加利亚共和国','Bulgaria','Republic of Bulgaria','BG','BGR','100'),
('32','大洋洲','Oceania','北马里亚纳','北马里亚纳自由联邦','NorthernMarianas','Commonwealth of the NorthernMarianas','MP','MNP','580'),
('33','非洲','Africa','贝宁','贝宁共和国','Benin','Republic of Benin','BJ','BEN','204'),
('34','欧洲','Europe','比利时','比利时王国','Belgium','Kingdom of belgium','BE','BEL','056'),
('35','欧洲','Europe','冰岛','冰岛共和国','Iceland','Republic of Iceland','IS','ISL','352'),
('36','北美洲','North America','波多黎各','波多黎各自由联邦','PuertoRico','Commonwealth of PuertoRico','PR','PRI','630'),
('37','欧洲','Europe','波兰','波兰共和国','Poland','Republic of Poland','PL','POL','616'),
('38','欧洲','Europe','波斯尼亚和墨塞哥维那','波斯尼亚和黑塞哥维那共和国','Bosniaand Herzegovina','Republic of Bosniaand Herzegovina','BA','BIH','070'),
('39','南美洲','South America','玻利维亚','玻利维亚共和国','Bolivia','Republic of Bolivia','BO','BOL','068'),
('40','北美洲','North America','伯利兹','伯利兹','Belize','Belize','BZ','BLZ','084'),
('41','非洲','Africa','博茨瓦纳','博茨瓦纳共和国','Botswana','Republic of Botswana','BW','BWA','072'),
('42','亚洲','Asia','不丹','不丹王国','Bhutan','Kingdom of Bhutan','BT','BTN','064'),
('43','非洲','Africa','布基纳法索','布基纳法索','BurkinaFaso','BurkinaFaso','BF','BFA','854'),
('44','非洲','Africa','布隆迪','布隆迪共和国','Burundi','Republic of Burundi','BI','BDI','108'),
('45','亚洲','Asia','朝鲜','朝鲜民主主义人民共和国','North Korea','Democratic People\'s Republic of Korea','KP','PRK','408'),
('46','非洲','Africa','赤道几内亚','赤道几内亚共和国','Equatorial Guinea','Republic of Equatorial Guinea','GQ','GNQ','226'),
('47','欧洲','Europe','丹麦','丹麦王国','Denmark','Kingdom of Denmark','DK','DNK','208'),
('48','欧洲','Europe','德国','德意志联邦共和国','Germany','Federal Republic of Germany','DE','DEU','276'),
('49','亚洲','Asia','东帝汶','东帝汶','EastTimor','EastTimor','TP','TMP','626'),
('50','非洲','Africa','多哥','多哥共和国','Togo','Republic of Tago','TG','TGO','768'),
('51','北美洲','North America','多米尼加共和国','多米尼加共和国','Dominican Republic','Dominican Republic','DO','DOM','214'),
('52','北美洲','North America','多米尼克','多米尼克联邦','Dominica','Commonwealth of Dominica','DM','DMA','212'),
('53','欧洲','Europe','俄罗斯','俄罗斯联邦','Russia','Russian Federation','RU','RUS','643'),
('54','南美洲','South America','厄瓜多尔','厄瓜多尔共和国','Ecuador','Republic of Ecuador','EC','ECU','218'),
('55','非洲','Africa','厄立特里亚','厄立特里亚国','Eritrea','State of Eritrea','ER','ERI','232'),
('56','欧洲','Europe','法国','法兰西共和国','France','French Republic','FR','FRA','250'),
('57','欧洲','Europe','法罗群岛','法罗群岛','FaroeIslands','Faroe Islands','FO','FRO','234'),
('58','大洋洲','Oceania','法属波利尼西亚','法属波利尼西亚','French Polynesia','French Polynesia','PF','PYF','258'),
('59','南美洲','South America','法属圭亚那','法属圭亚那','French Guiana','French Guiana','GF','GUF','254'),
('60','欧洲','Europe','梵蒂冈','梵蒂冈城国','Vatican','Vatican City State','VA','VAT','336'),
('61','亚洲','Asia','菲律宾','菲律宾共和国','Philippines','Republic of the Philippines','PH','PHL','608'),
('62','大洋洲','Oceania','斐济','斐济共和国','Fiji','Republic of Fiji','FJ','FJI','242'),
('63','欧洲','Europe','芬兰','芬兰共和国','Finland','Republic of Finland','FI','FIN','246'),
('64','非洲','Africa','佛得角','佛得角共和国','CapeVerde','Republic of CapeVerde','CV','CPV','132'),
('65','非洲','Africa','冈比亚','冈比亚共和国','Gambia','Republic of Gambia','GM','GMB','270'),
('66','非洲','Africa','刚果','刚果共和国','Congo','Republic of Congo','CG','COG','178'),
('67','南美洲','South America','哥伦比亚','哥伦比亚共和国','Colombia','Republic of Colombia','Co','COL','170'),
('68','北美洲','North America','哥斯达黎加','哥斯达黎加共和国','CostaRica','Republic of CostaRica','CR','CR','188'),
('69','北美洲','North America','格林纳达','格林纳达','Grenada','Grenada','GD','GRD','308'),
('70','北美洲','North America','格陵兰','格陵兰','Greenland','Greenland','GL','GRL','304'),
('71','亚洲','Asia','格鲁吉亚','格鲁吉亚共和国','Georgia','Republic of Georgia','GE','GEO','268'),
('72','北美洲','North America','古巴','古巴共和国','Cuba','Republic of Cuba','CU','CUB','192'),
('73','北美洲','North America','瓜德罗普','瓜德罗普','Guadeloupe','Guadeloupe','GP','GLP','312'),
('74','大洋洲','Oceania','关岛','关岛','Guam','The Territory of Guam','GU','GUM','316'),
('75','南美洲','South America','圭亚那','圭亚那合作共和国','Guyana','Cooperative Republic of Guyana','GY','GUY','328'),
('76','亚洲','Asia','哈萨克斯坦','哈萨克斯坦共和国','Kazakhstan','Republic of Kazakhstan','KZ','KAZ','398'),
('77','北美洲','North America','海地','海地共和国','Haiti','Republic of Haiti','HT','HTI','332'),
('78','亚洲','Asia','韩国','大韩民国','Korea,Republic of ','Republic of Korea','KR','KOR','410'),
('79','欧洲','Europe','荷兰','荷兰王国','Netherlands','Kingdom of the Netherlands','NL','NLD','528'),
('80','北美洲','North America','荷属安的列斯','荷属安的列斯','Netherlands Antilles','Netherlands Antilles','AN','ANT','530'),
('81','北美洲','North America','洪都拉斯','洪都拉斯共和国','Honduras','Republic of honduras','HN','HND','340'),
('82','大洋洲','Oceania','基里巴斯','基里巴斯共和国','Kiribati','Republic of Kiribati','KI','KIR','296'),
('83','非洲','Africa','吉布提','吉布提共和国','Djibouti','Republic of Djibouti','DJ','DJI','262'),
('84','亚洲','Asia','吉尔吉斯斯坦','吉尔吉斯共和国','Kyrgyzstan','Kyrgyz Republic','KG','KGZ','417'),
('85','非洲','Africa','几内亚','几内亚共和国','Guinea','Republic of Guinea','GN','GIN','324'),
('86','非洲','Africa','几内亚比绍','几内亚比绍共和国','Guine-bissau','Republic of Guine-bissau','GW','GNB','624'),
('87','北美洲','North America','加拿大','加拿大','Canada','Canada','CA','CAN','124'),
('88','非洲','Africa','加纳','加纳共和国','Ghana','Republic of Ghana','GH','GHA','288'),
('89','非洲','Africa','加蓬','加蓬共和国','Gabon','Gabonese Republic','GA','GAB','266'),
('90','亚洲','Asia','柬埔寨','柬埔寨王国','Cambodia','Kingdom of Cambodia','KH','KHM','116'),
('91','欧洲','Europe','捷克','捷克共和国','CzechRepoublic','Czech Republic','CZ','CZE','203'),
('92','非洲','Africa','津巴布韦','津巴布韦共和国','Zimbabwe','Republic of Zimbabwe','ZW','ZWE','716'),
('93','非洲','Africa','喀麦隆','喀麦隆共和国','Cameroon','Republic of Cameroon','CM','CMR','120'),
('94','亚洲','Asia','卡塔尔','卡塔尔国','Qatar','State of Qatar','QA','QAT','634'),
('95','北美洲','North America','开曼群岛','开曼群岛','CaymanIslands','Cayman Islands','KY','CYM','136'),
('96','非洲','Africa','科摩罗','科摩罗伊斯兰联邦共和国','Comoros','Federal Islamic Republic of the Co-moros','KM','COM','174'),
('97','非洲','Africa','科特迪瓦','科特迪瓦共和国','Coted\'Ivoire','Republic of Coted\'Ivire','CI','CIV','384'),
('98','亚洲','Asia','科威特','科威特国','Kuwait','State of Kuwait','KW','KWT','414'),
('99','欧洲','Europe','克罗地亚','克罗地亚共和国','Croatia','Republic of Croatia','HR','HRV','191'),
('100','非洲','Africa','肯尼亚','肯尼亚共和国','Kenya','Republic of Kenya','KE','KEN','404'),
('101','大洋洲','Oceania','库克群岛','库克群岛','CookIslands','Cook Islands','CK','COK','184'),
('102','欧洲','Europe','拉脱维亚','拉脱维亚共和国','Latvia','Republic of Latvia','LV','LVA','428'),
('103','非洲','Africa','莱索托','莱索托王国','Lesotho','Kingdom of Lesoto','LS','LSO','426'),
('104','亚洲','Asia','老挝','老挝人民民主共和国','Lao','LaoPeople\'s Democratic Republic','LA','LAO','418'),
('105','亚洲','Asia','黎巴嫩','黎巴嫩共和国','Lebanon','Republic of Lebanon','LB','LBN','422'),
('106','欧洲','Europe','立陶宛','立陶宛共和国','Lithuania','Republic of Lithuania','LT','LTU','440'),
('107','非洲','Africa','利比里亚','利比里亚共和国','Liberia','Republic of Liberia','LR','LBR','430'),
('108','非洲','Africa','利比亚','大阿拉伯利比亚人民社会主义民众国','Libya','Great Socialist People\'s Libyan Arabjamahiriya','LY','LBY','434'),
('109','欧洲','Europe','列支敦士登','列支敦士登公国','Liechtenstein','Principality of Liechtenstein','LI','LIE','438'),
('110','非洲','Africa','留尼旺','留尼汪','Reunion','Reunion','RE','REU','638'),
('111','欧洲','Europe','卢森堡','卢森堡大公国','Luxembourg','GrandDuchy of Luxembourg','LU','LUX','442'),
('112','非洲','Africa','卢旺达','卢旺达共和国','Rwanda','Republic of Rwanda','RW','RWA','646'),
('113','欧洲','Europe','罗马尼亚','罗马尼亚','Romania','Romania','RO','ROM','642'),
('114','非洲','Africa','马达加斯加','马达加斯加共和国','Madagascar','Republic of Madagascar','MG','MDG','450'),
('115','亚洲','Asia','马尔代夫','马尔代夫共和国','Maldives','Republic of maldives','MV','MDV','462'),
('116','欧洲','Europe','马耳他','马耳他共和国','Malta','Republic of Malta','MT','MLT','470'),
('117','非洲','Africa','马拉维','马拉维共和国','Malawi','Republic of Malawi','MW','MWI','454'),
('118','亚洲','Asia','马来西亚','马来西亚','Malaysia','Malaysia','MY','MYS','458'),
('119','非洲','Africa','马里','马里共和国','Mali','Republic of Mali','ML','MLI','466'),
('120','大洋洲','Oceania','马绍尔群岛','马绍尔群岛共和国','Marshall Islands','Republic of the Marshall Islands','MH','MHL','584'),
('121','欧洲','Europe','马其顿','马其顿共和国','Macedonia','Republic of Macedonia','MK','MKD','807'),
('122','北美洲','North America','马提尼克','马提尼克','Martinique','Martinique','MQ','MTQ','474'),
('123','非洲','Africa','毛里求斯','毛里求斯共和国','Mauritius','The Republic of Mauritius','MU','MUS','480'),
('124','非洲','Africa','毛里塔尼亚','毛里塔尼亚伊斯兰共和国','Mauritania','The Islamic Republic of Mauritania','MR','MRT','478'),
('125','北美洲','North America','美国','美利坚合众国','UnitedStates','United States of America','US','USA','840'),
('126','大洋洲','Oceania','美属萨摩亚','美属萨摩亚','AmericanSamoa','American Samoa','AS','ASM','016'),
('127','北美洲','North America','美属维尔京群岛','','United States Miscella-neous Pac','','UM','UMI','581'),
('128','亚洲','Asia','蒙古','蒙古国','Mongolia','Mongolia','MN','MNG','496'),
('129','北美洲','North America','蒙特塞拉特','蒙特塞拉特','Montserrat','Montserrat','MS','MSR','500'),
('130','亚洲','Asia','孟加拉国','孟加拉人民共和国','Bangladesh','People\'s Republic of Bangladesh','BD','BGD','050'),
('131','南美洲','South America','秘鲁','秘鲁共和国','Peru','Republic of Peru','PE','PER','604'),
('132','大洋洲','Oceania','密克罗尼西亚','密克罗尼西亚联邦','Micronesia','Federated States of Micronesia','FM','FSM','583'),
('133','亚洲','Asia','缅甸','缅甸联邦','Myanmar','Union of Myanmar','MM','MMR','104'),
('134','欧洲','Europe','摩尔多瓦','摩尔多瓦共和国','Moldova','Republic of Moldova','MD','MDA','498'),
('135','非洲','Africa','摩洛哥','摩洛哥王国','Morocco','Kingdom of Morocco','MA','MAR','504'),
('136','欧洲','Europe','摩纳哥','摩纳哥公国','Monaco','PrincipalityofMonaco','MC','MCO','492'),
('137','非洲','Africa','莫桑比克','莫桑比克共和国','Mozambique','Republic of Mozambique','MZ','MOZ','508'),
('138','北美洲','North America','墨西哥','墨西哥合众国','Mexico','United States of Mexico','MX','MEX','484'),
('139','非洲','Africa','纳米比亚','纳米比亚共和国','Namibia','Republic of Namibia','NA','NAM','516'),
('140','非洲','Africa','南非','南非共和国','SouthAfrica','Republic of SouthAfrica','ZA','ZAF','710'),
('141','亚洲','Asia','尼泊尔','尼泊尔王国','Nepal','Kingdom of Nepal','NP','NPL','524'),
('142','北美洲','North America','尼加拉瓜','尼加拉瓜共和国','Nicaragua','Republic of Nicaragua','NI','NIC','558'),
('143','非洲','Africa','尼日尔','尼日尔共和国','Niger','Republic of Niger','NE','NER','562'),
('144','非洲','Africa','尼日利亚','尼日利亚联邦共和国','Nigeria','Federal Republic of Nigeria','NG','NGA','566'),
('145','大洋洲','Oceania','纽埃','纽埃','Niue','Niue','NU','NIU','570'),
('146','欧洲','Europe','挪威','挪威王国','Norway','Kingdom of Norway','NO','NOR','578'),
('147','大洋洲','Oceania','皮特凯恩岛','皮竺凯恩群岛','Pitcairn Islands Group','Pitcairn Islands Group','PN','PCN','612'),
('148','欧洲','Europe','葡萄牙','葡萄牙共和国','Portugal','Pirtuguese Republic','PT','PRT','620'),
('149','亚洲','Asia','日本','日本国','Japan','Japan','JP','JPN','392'),
('150','欧洲','Europe','瑞典','瑞典王国','Sweden','Kingdom of Sweden','SE','SWE','752'),
('151','欧洲','Europe','瑞士','瑞士联邦','Switzerland','Swiss Confederation','CH','CHE','756'),
('152','北美洲','North America','萨尔瓦多','萨尔瓦多共和国','ElSalvador','Republic of ElSalvador','SV','SLV','222'),
('153','欧洲','Europe','塞尔维亚','塞拉利昂共和国','Sierraleone','Republic of SierraLeone','SL','SLE','694'),
('154','非洲','Africa','塞拉利昂','塞内加尔共和国','Senegal','Republic of Senegal','SN','SEN','686'),
('155','非洲','Africa','塞内加尔','塞浦路斯共和国','Cyprus','Republic of Cyprus','CY','CYP','196'),
('156','非洲','Africa','塞舌尔','塞舌尔共和国','Seychells','Republic of Seychelles','SC','SYC','690'),
('157','亚洲','Asia','沙特阿拉伯','沙特阿拉伯王国','SaudiArabia','Kingdom of SaudiArabia','SA','SAU','682'),
('158','非洲','Africa','圣多美及普林西比','圣多美和普林西比民主共和国','Sao Tomeand Principe','Democratic Republic of Sao Tomeand Principe','St','STp','678'),
('159','非洲','Africa','圣赫勒拿','对赫勒拿','Sainthelena','SaintHelena','Sh','SHN','654'),
('160','北美洲','North America','圣基茨和尼维斯','圣革茨和尼维斯联邦','Saint Kittsandnevis','Federation of Saint Kittsandnevis','KN','KNA','659'),
('161','北美洲','North America','圣卢西亚','圣卢西亚','Saintlucia','SaintLucia','LC','LCA','662'),
('162','欧洲','Europe','圣马力诺','圣马力诺共和国','SanMarion','Republic of SanMarino','SM','SMR','674'),
('163','北美洲','North America','圣文森特和格林纳丁斯','圣文森特和格林纳丁斯','Saint Vincent and the Grenadines','Saint Vincent and the Grenadines','VC','VCT','670'),
('164','亚洲','Asia','斯里兰卡','斯里兰卡民主社会主义共和国','SriLanka','Democratic Socialist Republic of Srilanka','LK','LKA','144'),
('165','欧洲','Europe','斯洛伐克','斯洛伐克共和国','Slovakia','Slovak Republic','SK','SVK','703'),
('166','欧洲','Europe','斯洛文尼亚','斯洛文尼亚共和国','Slovenia','Republic of Slovenia','SI','SVN','705'),
('167','非洲','Africa','斯威士兰','斯威士兰王国','Swaziland','Kingdom of Swaziland','SZ','SWZ','748'),
('168','非洲','Africa','苏丹','苏丹共和国','Sudan','Republic of theSudan','SD','SDN','736'),
('169','南美洲','South America','苏里南','苏里南共和国','Suriname','Republic of Suriname','SR','SUR','740'),
('170','大洋洲','Oceania','所罗门群岛','年罗门群岛','Solomon Islands','Solomon Islands','SB','SLB','090'),
('171','非洲','Africa','索马里','索马里共和国','Somalia','Somali Republic','SO','SOM','706'),
('172','亚洲','Asia','塔吉克斯坦','塔吉克斯坦共和国','Tajikistan','Republic of Tajikistan','TJ','TJK','762'),
('173','亚洲','Asia','泰国','泰王国','Thailand','Kingdom of Thailand','TH','THA','764'),
('174','非洲','Africa','坦桑尼亚','坦桑尼亚联合共和国','Tanzania','UnitedRepublic of Tanzania','TZ','TZA','834'),
('175','大洋洲','Oceania','汤加','汤加王国','Tonga','Kingdom of Tonga','TO','TON','776'),
('176','北美洲','North America','特克斯和凯科斯群岛','特克斯和凯科斯群岛','Turksand Caicos Islands','Turksand Caicos Islands','TC','TCA','796'),
('177','北美洲','North America','特立尼达和多巴哥','特立尼达和多巴哥共和国','Trinidadand Tobago','Republic of Trinidadand Tobago','TT','TTO','780'),
('178','非洲','Africa','突尼斯','突尼斯共和国','Tunisia','Republic of Tunisia','TN','TUN','788'),
('179','大洋洲','Oceania','图瓦卢','图瓦卢','Tuvalu','Tuvalu','TV','TUV','798'),
('180','亚洲','Asia','土耳其','土耳其共和国','Turkey','Republic of Turkey','TR','TUR','792'),
('181','亚洲','Asia','土库曼斯坦','土库曼斯坦','Turkmenistan','Turkmenistan','TM','TKM','795'),
('182','大洋洲','Oceania','托克劳','托克劳','Tokelau','Tokelau','TK','TKL','772'),
('183','大洋洲','Oceania','瓦努阿图','瓦努阿图共和国','Vanuatu','Republic of Vanuatu','VU','VUT','548'),
('184','北美洲','North America','危地马拉','危地马拉共和国','Guatemala','Republic of Guatemala','GT','GTM','320'),
('185','南美洲','South America','委内瑞拉','委内瑞拉共和国','Venezuela','Republic of Venezuela','VE','VEN','862'),
('186','亚洲','Asia','文莱','文莱达鲁萨兰国','Brunei Darussalam','Brunei Darussalam','BN','BRN','096'),
('187','非洲','Africa','乌干达','乌干达共和国','Uganda','Republic of Uganda','UG','UGA','800'),
('188','欧洲','Europe','乌克兰','乌克兰','Ukraine','Ukraine','UA','UKR','804'),
('189','南美洲','South America','乌拉圭','乌拉圭东岸共和国','Uruguay','Oriental Republic of Uruguay','UY','URY','858'),
('190','亚洲','Asia','乌兹别克斯坦','乌兹别克斯坦共和国','Uzbekistan','Republic of Uzbekistan','UZ','UZB','860'),
('191','欧洲','Europe','西班牙','西班牙','Spain','Spain','ES','ESP','724'),
('192','非洲','Africa','西撒哈拉','西撒哈拉','Western Sahara','Western Sahara','EH','ESH','732'),
('193','欧洲','Europe','希腊','希腊共和国','Greece','Hellenic Republic','GR','GRC','300'),
('194','亚洲','Asia','新加坡','新加坡共和国','Singapore','Republic of Singapore','SG','SGP','702'),
('195','大洋洲','Oceania','新喀里多尼亚','新喀里多尼亚','NewCaledonia','NewCaledonia','NC','NCL','540'),
('196','大洋洲','Oceania','新西兰','新西兰','NewZealand','NewZealand','NZ','NZL','554'),
('197','欧洲','Europe','匈牙利','匈牙利共和国','Hungary','Republic of Hungary','HU','HUN','348'),
('198','亚洲','Asia','叙利亚','阿拉伯叙利亚共和国','Syria','Syrian Arab Republic','SY','SYR','760'),
('199','北美洲','North America','牙买加','牙买加','Jamaica','Jamaica','JM','JAM','388'),
('200','亚洲','Asia','亚美尼亚','亚美尼亚共和国','Armenia','Republic of Armenia','AM','ARM','051'),
('201','亚洲','Asia','也门','也门共和国','Yemen','Republic of Yemen','YE','YEM','887'),
('202','亚洲','Asia','伊拉克','伊拉克共和国','Iraq','Republic of Iraq','IQ','IRQ','368'),
('203','亚洲','Asia','伊朗','伊朗伊斯兰共和国','Iran','Islamic Rupublic of Iran','IR','IRN','364'),
('204','亚洲','Asia','以色列','以色列国','Israel','State of Israel','IL','ISR','376'),
('205','欧洲','Europe','意大利','意大利共和国','Italy','Republic of Italy','IT','ITA','380'),
('206','亚洲','Asia','印度','印度共和国','India','Republic of India','IN','IND','356'),
('207','亚洲','Asia','印度尼西亚','印度尼西亚共和国','Indonesia','Republic of Indonesia','ID','IDN','360'),
('208','欧洲','Europe','英国','大不列颠及北爱尔兰联合王国','United Kingdom','United Kingdom of Great Britainand Northernireland','GB','GBR','826'),
('209','北美洲','North America','英属维尔京群岛','英属维尔京群岛','British Virgin Islands','British Virgin Islands','VG','VGB','092'),
('210','亚洲','Asia','约旦','约旦哈希姆王国','Jordan','Hashemite Kingdom of Jordan','JO','JOR','400'),
('211','亚洲','Asia','越南','越南社会主席共和国','VietNam','Socialist Republic of VietNam','VN','VNM','704'),
('212','非洲','Africa','赞比亚','赞比亚共和国','Zambia','Republic of Zambia','ZM','ZMB','894'),
('213','非洲','Africa','乍得','乍得共和国','Chad','Republic of Chad','TD','TCD','148'),
('214','亚洲','Asia','中国','中华人民共和国','China','People\'s Republic of China','CN ','CHN ','156'),
('215','南美洲','South America','智利','智利共和国','Chile','Republic of Chile','CL','CHL','152'),
('216','非洲','Africa','中非','中非共和国','Central Africa','Central African Republic','CF','CAF','140'),
('217','非洲','Africa','刚果（金）','刚果民主共和国','Democratic Republic of the Congo','Democratic Republic of the Congo','CD','COD','180');
