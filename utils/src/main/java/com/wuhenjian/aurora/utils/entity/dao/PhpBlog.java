...
public class PhpBlog extends Page implements Serializable {
	...
	public Integer getCommentAllowed() {
		return commentAllowed;
	}

	public void setCommentAllowed(Integer commentAllowed) {
	...
	public boolean equals(Object that) {
		...
		return (this.getPbId() == null ? other.getPbId() == null : this.getPbId().equals(other.getPbId()))
				...
				&& (this.getCommentAllowed() == null ? other.getCommentAllowed() == null : this.getCommentAllowed().equals(other.getCommentAllowed()))
	...
	public int hashCode() {
		...
		result = prime * result + ((getCommentAllowed() == null) ? 0 : getCommentAllowed().hashCode());
